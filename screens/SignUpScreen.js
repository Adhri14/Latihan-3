   ...
   return (
      <View style={styles.container}>
         <View style={styles.header}>
            <Animatable.Text animation='fadeInLeft' duration={1500} style={styles.title}>Register Account!</Animatable.Text>
         </View>
         <Animatable.View animation='fadeInUpBig' duration={2000} style={styles.footer}>
            ...
            <View>
               ...
               <TouchableOpacity onPress={() => navigation.goBack()} style={[styles.btn, styles.btnOutline]}>
                  <Text style={[styles.textBtn, styles.textBtnOutline]}>Login</Text>
               </TouchableOpacity>
            </View>
         </Animatable.View>
      </View>
